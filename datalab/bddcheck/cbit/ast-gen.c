...
int LLSIZE = 8*CSIZE;      /* Size of long long (bits) */
int LSIZE =  8*CSIZE;     /* Size of long (bits) */
int ISIZE =  4*CSIZE;     /* Size of int (bits) */
int FSIZE =  32;          /* Size of float (bits) */
int PSIZE =  8*CSIZE;     /* Size of pointer (bits) */
int SSIZE =  2*CSIZE;     /* Size of short (bits) */
int XLSIZE = 16*CSIZE;    /* Size of __int128 (bits) */
