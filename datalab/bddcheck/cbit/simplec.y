...
%token VAR INT FLOAT VOID UNSIGNED LONG SHORT CHAR INT128 NUM SEMI COMMA LPAREN RPAREN LBRACE RBRACE LBRACK RBRACK
...
type:
      ...
      | UNSIGNED INT128      { $$=cast_node(XLSIZE, DATA_UNSIGNED, NULL); }
      | INT128 UNSIGNED      { $$=cast_node(XLSIZE, DATA_UNSIGNED, NULL); }
      ...
      | INT128             { $$=cast_node(XLSIZE, DATA_SIGNED, NULL); }
